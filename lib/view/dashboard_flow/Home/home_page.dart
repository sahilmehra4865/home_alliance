                            ...
                            children: [
                              Expanded(
                                ...
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    const Text("Daily Earnings").regularText(
                                      AppColors.white,
                                      AppDimensions.d12.sp,
                                    ),
                                    AppSpacing.h10,
                                ...
                                child: Align(
                                  ...
                                  child: Column(
                                    crossAxisAlignment:
                                        CrossAxisAlignment.start,
                                    children: [
                                      const Text("Avg Job Rating").regularText(
                                        AppColors.white,
                                        AppDimensions.d12.sp,
                                      ),
                                      AppSpacing.h10,
                            ...
                            children: [
                              ...
                              DropdownButton<String>(
                                ...
                                selectedItemBuilder: (context) {
                                  return homePageController.filterOptions.map((
                                    e,
                                  ) {
                                    return SizedBox(
                                      width:
                              ...
                              Row(
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color:
                                          AppColors.primaryDrk, // dark blue dot
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Container(
                                        height:
                                            180.h, // bar length between 8 and 9
                                        width: 2.w,
